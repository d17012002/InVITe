                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between">
                            ...
                            <div className="text-left lg:text-right mt-4 lg:mt-0">
                                <button
                                    onClick={() =>
                                        router.push(
                                            `/adminevent/${eventId}/registration`
                                        )
                                    }
                                ...
                                {Array(3)
                                    ...
                                    .map((_, index) => (
                                        ...
                                        >
                                            ...
                                            mattis tristique augue sed sagittis.
                                            Vestibulum ultrices leo eu tortor
                                            euismod consectetur. Aenean sagittis
                                            erat a eros maximus commodo.
                                            Maecenas rhoncus enim a ipsum
                                            luctus, ut efficitur metus viverra.
                                            Etiam fermentum convallis lectus, in
                                            euismod mi commodo vitae. Nunc
                                            convallis feugiat ante, vel lobortis
                                            dolor pulvinar vitae.
                                        </p>
                                    ))}
                            </div>
